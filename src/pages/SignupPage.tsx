      ...
      <div className="w-full md:w-1/2 flex items-center justify-center p-6 md:p-12 lg:p-24 relative">
        ...
        <div className="w-full max-w-[400px] animate-slide-up">
          <header className="mb-10">
            <h1 className="text-4xl lg:text-5xl mb-3 text-luxury-950 dark:text-luxury-50">Create Account</h1>
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <span className="font-medium text-luxury-700 dark:text-luxury-200">Sign up with Google</span>
            </button>
